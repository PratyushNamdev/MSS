        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="mt-5 text-gray-300">
              Our cleaning and hygiene services are designed to maintain safe,
              sanitary, and well-managed environments covering routine
              housekeeping, deep sanitation, structural cleaning, and
          ...
          <div className="space-y-24">
            {cleaningAndHygieneServices.map((service, idx) => {
      ...
      <section className="relative py-12 bg-gray-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {cleaningAndHygieneCategories.map((category) => (
              <motion.div
                key={category.title}
                variants={fadeUp}
                initial="hidden"
